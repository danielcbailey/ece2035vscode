...
export function activate(context: vscode.ExtensionContext) {
    ...
    let newAssignmentCommand = vscode.commands.registerCommand(
        "ece2035.newAssignment",
    ...
    let debugTestCaseCommand = vscode.commands.registerCommand(
        "ece2035.debugTestCase",
        debugTestCase,
    );
    let deleteTestCaseCommand = vscode.commands.registerCommand(
        "ece2035.deleteTestCase",
        deleteTestCase,
    );
    let viewTestCaseCommand = vscode.commands.registerCommand("ece2035.viewTestCase", viewTestCase);
    let runAllTestCasesCommand = vscode.commands.registerCommand(
        "ece2035.runAllTestCases",
        runAllTestCases,
    );
    ...
    disposables.push(
        vscode.debug.registerDebugAdapterDescriptorFactory("riscv-vm", descriptionFactory),
    );
    ...
    context.subscriptions.push(
        vscode.window.registerTreeDataProvider("riscvtestcases", testCasesManager),
    );
